plot3 = function(){
  ...
  data = data[66637:69516, c(1,2,7,8,9)] 
  data$DateAndTime = strptime(paste(data[,1], data[,2]), format="%d/%m/%Y %H:%M:%S")
  
  ## Create the line plot and save it to as plot3.png
  png(file="plot3.png") ##opens PNG device. 480px x 480px is the default width and height
